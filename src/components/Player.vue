  ...
  <div class="player-box" v-bind:class="{full:isFullPage}" v-on:mousemove="currentPointHandler">
    <div class="full-page-toggle footer" v-bind:class="{full:isFullPage}" role="button"
      ...
      <span class="description"
            id="full-page-description">{{ isFullPage ? "Oynatıcıyı Daralt" : 'Oynatıcıyı Genişlet' }}</span>
      <span class="material-icons" v-if="isFullPage">
                keyboard_arrow_down
            </span>
    </div>
...
keyboard_arrow_right
    ...
    <div class="full-page-area" v-bind:class="{active:isFullPage}">
      <div class="photo-area">
        <img v-if="activeSound" v-bind:src="activeSound?`/images/${photoPath?photoPath:activeSound.imagePath}`:''"
             v-bind:alt="activeSound?alternativeText?alternativeText:'Bir zamanlar galatasarayda tanitim kapagi':''">
      </div>
    </div>
    ...
    <div class="controller-container">
      <div class="controller">
        <div class="player-button-box">
                    <span class="material-icons shuffle controller-button" aria-labelledby="shuffle-description"
                          role="button" v-bind:class="{active:isShuffle}"
                          tabindex="0"
        ...
        <div class="player-button-box">
                    <span class="material-icons replay controller-button" aria-labelledby="replay-description"
                          v-bind:class="{active:isReplay}"
                          tabindex="0"
